...
PG_DB_SCHEMA="${PG_DB_SCHEMA:-}"

DB_HOST_2="${DB_HOST_2:-localhost}"
DB_PORT_2="${DB_PORT_2:-5432}"
DB_DATABASE_2="${DB_DATABASE_2:-IDOSGD_MUNIPUNO}"
DB_USERNAME_2="${DB_USERNAME_2:-}"
DB_PASSWORD_2="${DB_PASSWORD_2:-}"
DB_CHARSET_2="${DB_CHARSET_2:-}"
DB_SCHEMA_2="${DB_SCHEMA_2:-}"
DB_SSLMODE_2="${DB_SSLMODE_2:-}"
